...
export const SEED_PRODUCTS = [
  {
    ...
    description:
      "An architectural, weighted desktop easel engineered for tablets, notebooks, and mobile workstations. Features an asymmetric 62-degree ergonomic incline, integrated silicone foot channels, and concealed cable passages.",
    price: 490.0,
    ...
    colors: ["Graphite Charcoal", "Paper Off-White", "Terracotta Umber", "Forged Matte Charcoal"],
